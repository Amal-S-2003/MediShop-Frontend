      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            {userLoggedIn ? (
              <NavLink to="/profile" className="text-gray-600 hover:text-gray-900 transition font-medium">
                Profile
              </NavLink>
            ) : (
              <NavLink to="/login" className="text-gray-600 hover:text-gray-900 transition font-medium">
                Login
              </NavLink>
            )}
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md">
          <div className="flex flex-col items-center space-y-3 py-4">
            <NavLink to="/" className="text-gray-700 hover:text-gray-900 transition font-medium" onClick={() => setIsOpen(false)}>
              Home
            </NavLink>
            <NavLink to="/about" className="text-gray-700 hover:text-gray-900 transition font-medium" onClick={() => setIsOpen(false)}>
              About
            </NavLink>
            <NavLink to="/cart" className="relative text-gray-700 hover:text-gray-900 transition font-medium" onClick={() => setIsOpen(false)}>
              Cart
              {cartCount > 0 && (
            ...
            {userLoggedIn ? (
              <NavLink to="/profile" className="text-gray-700 hover:text-gray-900 transition font-medium" onClick={() => setIsOpen(false)}>
                Profile
              </NavLink>
            ) : (
              <NavLink to="/login" className="text-gray-700 hover:text-gray-900 transition font-medium" onClick={() => setIsOpen(false)}>
                Login
              </NavLink>
            )}
          </div>
